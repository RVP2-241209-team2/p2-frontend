    ...
    <div className="w-[75%] mr-[15px]">
      <div className=" p-2 m-2">
        ...
        <div className="flex justify-between">
          ...
          <div onClick={()=>setEditAddress(!editAddress)} className="cursor-pointer text-[dodgerblue]">change</div>
        </div>}
        {!editAddress && <div>
          <div className="flex justify-between">
            <div className="text-lg font-medium"><span className="mr-3">1</span> Choose a shipping address</div>
            <div onClick={()=>setEditAddress(!editAddress)} className="cursor-pointer text-[dodgerblue]">Close</div>
          </div>
          <div className="ml-7 mt-2 border border-white rounded-md">
            ...
            <div className="cursor-pointer py-2 bg-[lightgrey] pl-3">
              <div className="w-fit py-1 px-3 rounded-3xl font-medium bg-[#ffd105] hover:bg-[#ffc505]">Use this address</div>
            </div>
          </div>
        </div>}
      ...
      <div className="p-2 m-2">
        ...
        <div className="ml-7 mt-2 border border-white rounded-md">
          ...
          <div className="cursor-pointer py-2 bg-[lightgrey] pl-3">
            <div className="w-fit py-1 px-3 rounded-3xl font-medium bg-[#ffd105] hover:bg-[#ffc505]">Use this payment method</div>
          </div>
        </div>
      </div>  
      <div className="p-2 m-2">
